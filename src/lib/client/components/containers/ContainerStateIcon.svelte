...
<div class="mx-2 sm:mx-3 w-16 sm:w-24 {$$props.class}"
	 class:text-error={state === 'dead' || state === 'removing'}
	 class:text-info={state === 'created'}
	 class:text-success={state === 'running'}
	 class:text-warning={state === 'paused' || state === 'restarting'}
>
	{#if state === 'created'}
